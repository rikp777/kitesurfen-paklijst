...
/**
 * Composition root. Owns only view state (what's open, search text, which
 * modal is up) and wires the domain hooks to the presentational components.
...
export default function App() {
  ...
  // Filter once per render: respects the "included" toggle and the search box.
  ...
  return (
    <div style={{ fontFamily: font, background: colors.bg, minHeight: "100vh", paddingBottom: 80 }}>
      <Toast message={toast} />
