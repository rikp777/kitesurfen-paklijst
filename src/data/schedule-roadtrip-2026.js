...
export const days = [
  ...
  // ── Dag 1 — Ma 10 aug: Vertrekdag ───────────────────────────────
  {
    ...
    slots: [
      s("rt-d0s1", "06:00", "🚗", "Vertrek Panningen", "Auto vol geladen, banden gecheckt en koffie voor onderweg. Op naar Oostenrijk!", "travel", "home", ["d1", "au1", "au2", "au3", "d8", "au9"]),
      ...
      s("rt-d0s9", "22:00", "🌙", "Welterusten", "Vroeg naar bed — morgen om 03:30 de wekker voor de Hochkönig. Sla de avondborreltjes over.", "rest", "stop-dienten"),
    ],
  },

  // ── Dag 2 — Di 11 aug: Hochkönig zonsopgangwandeling ────────────
  {
    id: "rt-day1",
    date: "2026-08-11",
    short: "Di 11/8",
    title: "Hochkönig",
    emoji: "🥾",
    note: "Langste dag van de trip! 6u omhoog + eten & chillen op de top + ~4u omlaag. Vertrek vóór zonsopgang (05:55) — in het donker starten. Zorg de avond ervoor dat alles klaarstaat: wandelschoenen, hoofdlamp + reserve batterijen, warme laag, 2L water, voldoende eten voor de hele dag.",
    slots: [
      s("rt-d1s1", "03:30", "⏰", "Wekker — nacht nog", "Vroegste wekker van de hele reis. Zo vroeg opstaan voelt wreed, maar de zonsopgang ergens op de klim maakt alles goed.", "rest", "stop-dienten"),
      s("rt-d1s2", "04:00", "🌙", "Licht ontbijt + inpakken", "Thermos koffie vullen, sandwiches en energierepen inpakken. Hoofdlamp checken op batterijen. Warme laag aan — het is koud in het donker.", "food", "stop-dienten"),
      s("rt-d1s3", "04:30", "🚗", "Rijden naar Arthurhaus parkeerplaats", "~20 min via Mühlbach am Hochkönig. Volg borden 'Arthurhaus'. Parkeren gratis bij de hut.", "travel", "hochkonig-trailhead"),
      s("rt-d1s4", "05:00", "🔦", "Start wandeling — vóór zonsopgang", "Vertrek in het donker met hoofdlamp. Arthurhaus (1502m) als startpunt. 6 uur klimmen voor de boeg. Sterrenhemel boven de Alpen.", "nature", "hochkonig-trailhead", ["ac5", "ac1", "ac6", "ac2", "kl5", "ac3"]),
      s("rt-d1s5", "05:55", "🌅", "Zonsopgang — vroeg in de klim", "De zon gaat op terwijl je pas net onderweg bent. Goud licht over de bergweiden — de dag begint goed.", "nature", "hochkonig-trailhead"),
      s("rt-d1s6", "11:00", "⛰️", "Hochkönig top (2941m)", "Na 6 uur klimmen: de top. Uitzicht over Salzburg, het Steinernes Meer, de Berchtesgadener Alpen en de Dachstein. 360° panorama. Matrashaus berghut is hier.", "nature", "hochkonig-summit", ["ac3", "ac4", "t4"]),
      s("rt-d1s7", "11:30", "🍳", "Eten & chillen op de top", "Sandwiches, koffie uit de thermos, warme soep bij de Matrashaus. Neem ruim de tijd — je hebt dit verdiend.", "food", "hochkonig-summit"),
      s("rt-d1s8", "13:00", "🥾", "Start afdaling (~4u)", "~4u terug naar beneden. Knieën en enkels voelen de afdaling zwaarder dan de klim — langzaam en bewust. Stokken zijn je beste vriend.", "nature", "hochkonig-trailhead"),
      s("rt-d1s9", "17:00", "🅿️", "Terug bij auto — Arthurhaus", "12u op de berg. Auto in zicht. Schoenen uit, stretch, water drinken.", "travel", "hochkonig-trailhead"),
      s("rt-d1s10", "17:30", "💧", "Triefen Waterval (korte stop)", "10 min rijden. Koude bergwaterval — verfrissing na zo'n dag. Optioneel als energie op is.", "nature", "triefen-waterfall"),
      s("rt-d1s11", "18:30", "🛁", "Terug in Dienten — douchen & rusten", "Warm douchen, benen omhoog. Vroeg eten en vroeg naar bed — morgen rijden naar Tsjechië.", "rest", "stop-dienten"),
      s("rt-d1s12", "20:00", "🍺", "Welverdiend Tyrols diner", "Schnitzel, Knödel en een Alpenrosé. 12u op de berg vreet energie — goed eten en vroeg slapen.", "evening", "stop-dienten"),
      s("rt-d1s13", "21:30", "🌙", "Welterusten — vroeg!", "12u op de berg. De spieren vragen om rust. Morgen vroeg vertrek naar Tsjechië — hoofd op het kussen.", "rest", "stop-dienten"),
    ],
  },
  ...
  // ── Dag 3 — Wo 12 aug: Dienten → Kutná Hora ─────────────────────
  {
    ...
    slots: [
      ...
      s("rt-d2s4", "11:30", "🛂", "Passau — grens AT/DE en DE/CZ", "Twee grenzen kort na elkaar. Bij Passau de Donau over, dan richting Tsjechië via de A3.", "travel", null, ["d7"]),
      ...
      s("rt-d2s10", "22:00", "🌙", "Welterusten", "Lange rijdag achter de rug. Morgen volle dag Kutná Hora — rust goed uit.", "rest", "stop-kutna"),
    ],
  },
  ...
  // ── Dag 4 — Do 13 aug: Kutná Hora ────────────────────────────────
  {
    ...
    slots: [
      ...
      s("rt-d3s8", "22:30", "🌙", "Welterusten", "Morgen ~420 km richting Polen. Vroeg opstaan — koffers al inpakken voor het slapen.", "rest", "stop-kutna"),
    ],
  },
  ...
  // ── Dag 5 — Vr 14 aug: Kutná Hora → Kraków ───────────────────────
  {
    ...
    slots: [
      ...
      s("rt-d4s4", "12:00", "🛂", "Grens CZ/PL bij Ostrava", "Grens oversteek. CZK kun je hier nog omwisselen. In Polen betaal je met PLN.", "travel", null, ["d6"]),
      ...
      s("rt-d4s10", "22:00", "🌙", "Welterusten — welkom in Polen", "Eerste nacht in Kraków. Morgen vroeg naar Wawel voor de kaartjes opraken.", "rest", "stop-krakow"),
    ],
  },
  ...
  // ── Dag 6 — Za 15 aug: Kraków — Historisch Centrum ───────────────
  {
    ...
    slots: [
      s("rt-d5s1", "09:00", "🏰", "Wawel Kasteel", "Vroeg gaan! Kaartjes zijn gelimiteerd. Kasteel, kathedraal én de koninklijke crypte met graven van de Poolse koningen.", "sight", "wawel-castle", ["t4", "d6", "ac5"]),
      ...
      s("rt-d5s8", "22:30", "🌙", "Welterusten", "Volledige dag Kraków zit erop. Morgen Wieliczka zoutmijn.", "rest", "stop-krakow"),
    ],
  },
  ...
  // ── Dag 7 — Zo 16 aug: Wieliczka Zoutmijn ────────────────────────
  {
    ...
    slots: [
      ...
      s("rt-d6s2", "10:00", "🧂", "Wieliczka Zoutmijn rondleiding", "9 niveaus diep. Highlights: Kapel van St. Kinga (volledig uitgehouwen in zout), ondergronds meer en immense zalen. ~3u.", "sight", "wieliczka", ["t4", "kl4", "d6"]),
      ...
      s("rt-d6s8", "22:00", "🌙", "Welterusten", "Morgen Schindler's Fabriek en Nowa Huta — boek je ticket vanavond nog als dat nog niet gedaan is!", "rest", "stop-krakow"),
    ],
  },
  ...
  // ── Dag 8 — Ma 17 aug: Schindler + Nowa Huta ─────────────────────
  {
    ...
    slots: [
      ...
      s("rt-d7s8", "23:00", "🌙", "Welterusten", "Vrije dag morgen — je mag iets later slapen. Maar zet wel een wekker.", "rest", "stop-krakow"),
    ],
  },
  ...
  // ── Dag 9 — Di 18 aug: Vrije dag Kraków ──────────────────────────
  {
    ...
    slots: [
      ...
      s("rt-d8s7", "23:30", "🌙", "Welterusten", "Morgen Auschwitz — vroeg vertrek (07:30). Zorg dat je uitgerust bent voor een emotionele dag.", "rest", "stop-krakow"),
    ],
  },
  ...
  // ── Dag 10 — Wo 19 aug: Auschwitz-Birkenau ───────────────────────
  {
    ...
    slots: [
      ...
      s("rt-d9s2", "09:00", "🕯️", "Auschwitz I — geleid bezoek", "Geleide rondleiding door het kamp. Baraken, appelplaats, Blok 11 en de beruchte gasingang. Spreek zacht.", "sight", "auschwitz", ["ac2", "g9", "ac5"]),
      ...
      s("rt-d9s8", "21:30", "🌙", "Welterusten", "Emotionele dag. Schrijf je gedachten op in de dagnotitie als je dat wilt. Rust goed uit.", "rest", "stop-krakow"),
    ],
  },
  ...
  // ── Dag 11 — Do 20 aug: Kraków → Quedlinburg ─────────────────────
  {
    ...
    slots: [
      ...
      s("rt-d10s10", "22:00", "🌙", "Welterusten — bijna thuis", "Morgen de laatste ~570 km. Koffers alvast klaarzetten. Bijna thuis!", "rest", "stop-quedlinburg"),
    ],
  },
  ...
  // ── Dag 12 — Vr 21 aug: Quedlinburg → Thuis ─────────────────────
  {
    ...
    slots: [
      ...
      s("rt-d11s4", "10:30", "🚗", "Vertrek naar Nederland", "A395 → A36 → A2 richting Hannover → Osnabrück → grens NL. Via A1 naar Limburg.", "travel", null, ["d1", "au1", "au2"]),
      ...
      s("rt-d11s9", "22:00", "🌙", "Welterusten — thuis!", "Eigen bed, eigen kussen. Slaap lekker na een onvergetelijke trip.", "rest", "home"),
    ],
  },
